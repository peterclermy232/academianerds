      ...
      <div className="home-container">
        <div className="contains">
          <div className="d-flex justify-content-between section-container">
            ...
            <div className="text-section" style={{ marginLeft: '170px', color: 'white'}}>
                <h1 className="mb-4 ml-5" style={{ fontSize: '40px', color: 'white' }}>Boost Productivity, Reduce Stress & <br /> Achieve Your Goals</h1>
                <p style={{ lineHeight: '5rem', color: 'white' }}>
            ...
            <div className="card price-section p-4">
                ...
                <form>
                    ...
                    <div className="text-right">
                        <strong className="text-right" style={{color: 'white'}}>Price (USD): </strong><span id="price-display" className="text-right" style={{color: 'white'}}>${total}</span>
                    </div>
                    <div className="text-right">
                        <strong className="text-right" style={{color: 'white'}}>Word Count: </strong><span className="wordcount" style={{color: 'white'}}>{wordCount} words</span>
                    </div>
                    <div className="op-row flex justify-center my-4">
                        <div className="opc1btn">
                            <a href="/order" className="op-sm-12 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                ORDER NOW
                            </a>
                        </div>
                    </div>
